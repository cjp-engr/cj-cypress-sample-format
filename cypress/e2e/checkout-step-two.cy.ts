...
describe('Checkout Step Two Page', () => {
    describe('Visit checkout step two page scenario', () => {
        ...
        it('Should successfully route to Checkout step two page after clicking the "Checkout" button', function () {
    ...
    describe('Added all the products from cart scenarios', () => {
        ...
        it('Should successfully display all the products added from the Inventory page', function () {
        ...
        it('Should successfully display the "Payment Information"', function () {
        ...
        it('Should successfully display the "Shipping Information"', function () {
        ...
        it('Should successfully display the correct subtotal for all the products added', function () {
            CheckoutStepTwoPage.itemTotalValueElement.should((subTotal) => {
                expect(subTotal).to.contain('Item total: $129.94');
            });
        });

        it('Should successfully display the correct tax for all the products added', function () {
            CheckoutStepTwoPage.taxValueElement.should((tax) => {
                expect(tax).to.contain('Tax: $10.40');
            });
        });

        it('Should successfully display the correct total for all the products added', function () {
            CheckoutStepTwoPage.totalValueElement.should((total) => {
                expect(total).to.contain('Total: $140.34');
            });
        });

        it('Should successfully display the correct total number of products - shopping cart badge', function () {
            CheckoutStepTwoPage.shoppingCartBadgeElement.should((badge) => {
                expect(badge).to.contain('6');
            });
        });

        it('Should successfully complete the transaction after clicking the "Finish" button', function () {
